...
class Bolchal(private val context: Context): TextToSpeech.OnInitListener  {
    ...
    val availableLanguages: Set<Locale>
        @SuppressLint("ObsoleteSdkInt") @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    ...
    companion object {
        ...
        internal val TAG = Bolchal::class.java.simpleName
